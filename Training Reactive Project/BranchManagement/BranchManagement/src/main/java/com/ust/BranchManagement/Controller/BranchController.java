...
public class BranchController {
	...
	@GetMapping("/withStudents/{coursecode}")
	public ResponseDto getStudent(@PathVariable("coursecode") int coursecode) {
		ResponseDto responsedto = service.getCoursecode(coursecode);
		return responsedto;
	}
}
